...
- Interactive focus states across home and work pages now use a shared brand-red `:focus-visible` outline with a matching soft red halo on control-style elements like the spinning logo, rail nav items, social icons, cards, CTAs, and the `cols` toggle.
