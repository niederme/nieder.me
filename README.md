...
- The site shell now keeps a fixed black viewport backdrop behind both home and work pages so mobile Safari pull-to-refresh reveals black instead of a gray band; work pages also declare a black browser `theme-color`.
