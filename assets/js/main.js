...
const BROWSER_THEME_COLOR = "#ff453a";

const CONSOLE_SIGNATURE_BASE64 = "";

const getConsoleSignature = () => {
  try {
    return window.atob(CONSOLE_SIGNATURE_BASE64);
  } catch (error) {
    return "";
  }
};
...
{
  const consoleSignature = getConsoleSignature();

  if (consoleSignature && typeof console !== "undefined" && typeof console.log === "function") {
    ...
    console.log(`%c${consoleSignature}`, signatureStyle);
    console.log(
      "%cJohn Nieder / Product Design & Direction\nhttps://nieder.me",
      "color: currentColor; font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace; font-size: 12px;"
    );
  }
};
...
if (themeToggles.length > 0) {
  const applyTheme = (theme, persist = true) => {
    ...
    if (themeColorMeta) {
      themeColorMeta.setAttribute("content", BROWSER_THEME_COLOR);
    }
    if (colorSchemeMeta) {
