...
- Replaced the browser-default focus treatment with a consistent white `:focus-visible` outline across interactive elements.
- Added a restrained brand-red halo to control-style elements, including the spinning logo, rail nav controls, social icons, cards, CTA buttons, and the `cols` toggle.
...
## Verification
- Keyboard through the homepage and confirm the logo, left rail anchors, social links, CTA buttons, footer links, and `cols` toggle all show the white focus ring.
